...
//import WavUploadCard from "@/components/dashboard/MLapi"; // adjust path if needed
import WavUploadCard from "@/components/dashboard/WavUploadCard";
import WavCompareCard from "@/components/dashboard/WavCompareCard";
//import WavCompareOrUploadCard from "@/components/dashboard/WavCompareOrUploadCard";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="container mx-auto px-6 py-6">
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full lg:w-auto lg:inline-flex grid-cols-5 lg:grid-cols-none">
            ...
            <TabsTrigger value="ml-audio">ML Audio</TabsTrigger>
         ...
         <TabsContent value="ml-audio" className="space-y-6">
        <div className="bg-card border border-border rounded-lg p-6 space-y-10">
          <div>
            <h3 className="text-lg font-semibold mb-2">AI vs Human Classifier</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Upload a single WAV file to determine whether the voice is synthetic or human.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-2">Same Speaker Checker</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Upload two different WAV files to check if the same person is speaking.
            </p>
            <div className="max-w-xl">
              <WavCompareCard />
            </div>
