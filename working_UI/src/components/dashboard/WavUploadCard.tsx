// src/components/dashboard/WavUploadCard.jsx
      ...
      <CardContent>
        ...
        <Box sx={{ mt: 3, display: "flex", gap: 1 }}>
          <Button component="label" variant="outlined" startIcon={<UploadFileIcon />} disabled={uploading}>
            Choose WAV
            <input hidden type="file" accept=".wav,audio/wav" onChange={onSelect} />
          </Button>
          <Button variant="contained" onClick={onSubmit} disabled={!file || uploading}>
